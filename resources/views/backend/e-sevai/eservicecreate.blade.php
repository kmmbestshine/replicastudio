            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <form action="{{route('eservice.store')}}" method="post">
                                {{ csrf_field()}}
                                ...
                                <div class="box-footer">
                                    <button type="submit" name="btnCreate" class="btn btn-primary" >Save Eservice</button>
                                </div>
                            </form>
                        </div>
                    </div>
