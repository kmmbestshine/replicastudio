...
class ExpensesController extends Controller
{
    ...
    public function index()
    {
        ...
        $expenses = Expense::where('company_id',Auth::user()->company_id)->orderBy('created_at', 'DEC')->get();
    ...
    public function create()
    {
        ...
        $expensesheading = Expensestitle::where('company_id',Auth::user()->company_id)->orderBy('created_at', 'DEC')->get();
    ...
    public function store(Request $request)
    {
        ...
        $exp->company_id = Auth::user()->company_id;
    ...
    public function edit($id)
    {
        ...
        $expenses = Expense::where('company_id',Auth::user()->company_id)->find($id);
    ...
    public function update(Request $request, $id)
    {
        ...
        $expenses->company_id = Auth::user()->company_id;
    ...
    public function destroy($id)
    {
        ...
        if ($check) {
            ...
            $staff = Expense::where('company_id',Auth::user()->company_id)->find($id);
    ...
    public function expensesheadingstore(Request $request)
    {
        ...
        $message = Expensestitle::where('company_id',Auth::user()->company_id)->create([
            'name' => $request->name,
    ...
    {
        $allexpenses = Expense::where('company_id',Auth::user()->company_id)->orderBy('created_at','DEC')->get();
